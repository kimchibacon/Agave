...
#ifndef AGAVE_DELEGATE_H
#define AGAVE_DELEGATE_H

/// rich 2018/11/30 - some of the code used to generate compiler errors for unsupported features
/// require the clang warning "-Wunused-local-typedef" to be disabled.
